...
import { Sparkles, Zap, Crown, Loader2, ArrowRight, Check, Plus, X } from "lucide-react";
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 w-full max-w-4xl mb-10">
              ...
              >
                ...
                <p className="text-3xl text-violet-400 mb-6">
                  €9.99<span className="text-lg text-slate-400">/mes</span>
                </p>
                <ul className="space-y-3">
                  {[
            ...
            <motion.button
              ...
              whileHover={
                selectedPlan
                  ? { scale: 1.04, boxShadow: "0 0 40px rgba(6,182,212,0.4)" }
                  : {}
              }
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative p-6 rounded-2xl bg-slate-900/70 backdrop-blur-md border border-cyan-500/30">
                      ...
                      <textarea
                        ...
                        placeholder="Ejemplo: Soy desarrollador full stack con 5 años de experiencia en React y Node.js..."
                      ...
                      >
                        <div className="pb-4 border-b border-slate-700">
                          ...
                          <p className="text-slate-400 text-sm mt-2">
                            {preview.personalInfo?.bio}
                          </p>
                        </div>

                        {preview.experience?.length > 0 && (
                          <div>
                            <h5 className="text-xs text-slate-500 mb-3 tracking-widest">
                              EXPERIENCIA
                            </h5>
                        ...
                        <motion.button
                          ...
                          className="w-full py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-violet-600 text-white transition-all"
                        >
